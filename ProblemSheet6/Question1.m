...
p3 = @(x) (x-1)*((x-3)^2);      % p3 = x^3 - 7x^2 + 15x - 9 (after expanding)
...
% c> using roots() to get all the root values (even the complex roots also)
p1_coeff = [4 0 3.2 0 -4];  % can use both row & column vector
